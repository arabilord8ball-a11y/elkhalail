...
export const THEMES = {
  'luxury-gold': {
    ...
    vars: {
      ...
      '--primary-dark': '#A67C2E',
      '--primary-bg': 'rgba(201, 151, 58, 0.1)',
      '--primary-bg-hover': 'rgba(201, 151, 58, 0.15)',
      ...
      '--admin-sidebar-active': 'rgba(201, 151, 58, 0.15)',
      '--admin-card': '#14141F',
  ...
  'ocean-breeze': {
    ...
    vars: {
      ...
      '--site-border': '#BAE6FD',
      '--site-text': '#0C4A6E',
      '--site-text-muted': '#0369A1',
      '--site-heading': '#0C4A6E',
      '--admin-bg': '#0C1A2E',
      '--admin-sidebar': '#0F2740',
      '--admin-sidebar-text': 'rgba(186, 230, 253, 0.8)',
      '--admin-sidebar-active': 'rgba(14, 165, 233, 0.2)',
      '--admin-card': '#132035',
      '--admin-card-border': 'rgba(14, 165, 233, 0.12)',
  ...
  'emerald-forest': {
    ...
    vars: {
      ...
      '--primary-bg-hover': 'rgba(16, 185, 129, 0.18)',
      ...
      '--site-border': '#BBF7D0',
      '--site-text': '#14532D',
      '--site-text-muted': '#166534',
      '--site-heading': '#052E16',
      '--admin-bg': '#071A10',
      '--admin-sidebar': '#0A2415',
      '--admin-sidebar-text': 'rgba(187, 247, 208, 0.8)',
      '--admin-sidebar-active': 'rgba(16, 185, 129, 0.2)',
      '--admin-card': '#0D2E1A',
      '--admin-card-border': 'rgba(16, 185, 129, 0.12)',
      '--font-main': "'Inter', system-ui, sans-serif",
  ...
  'royal-purple': {
    ...
    vars: {
      ...
      '--primary-bg-hover': 'rgba(139, 92, 246, 0.18)',
      ...
      '--site-border': '#DDD6FE',
      '--site-text': '#2E1065',
      '--site-text-muted': '#5B21B6',
      '--site-heading': '#1E1B4B',
      '--admin-bg': '#120B2E',
      '--admin-sidebar': '#1A1040',
      '--admin-sidebar-text': 'rgba(221, 214, 254, 0.8)',
      '--admin-sidebar-active': 'rgba(139, 92, 246, 0.2)',
      '--admin-card': '#1E1545',
      '--admin-card-border': 'rgba(139, 92, 246, 0.15)',
      '--font-main': "'Inter', system-ui, sans-serif",
  ...
  'rose-luxe': {
    ...
    vars: {
      ...
      '--primary-bg-hover': 'rgba(244, 63, 94, 0.15)',
      ...
      '--site-border': '#FECDD3',
      '--site-text': '#4C0519',
      '--site-text-muted': '#9F1239',
      '--site-heading': '#4C0519',
      '--admin-bg': '#1A0510',
      '--admin-sidebar': '#260818',
      '--admin-sidebar-text': 'rgba(254, 205, 211, 0.8)',
      '--admin-sidebar-active': 'rgba(244, 63, 94, 0.2)',
      '--admin-card': '#2D0A1E',
      '--admin-card-border': 'rgba(244, 63, 94, 0.12)',
      '--font-main': "'Inter', system-ui, sans-serif",
  ...
  'midnight-slate': {
    ...
    vars: {
      ...
      '--primary-bg-hover': 'rgba(100, 116, 139, 0.18)',
      ...
      '--site-heading': '#0F172A',
      '--admin-bg': '#0A0F1A',
      '--admin-sidebar': '#0F1729',
      '--admin-sidebar-text': 'rgba(203, 213, 225, 0.8)',
      '--admin-sidebar-active': 'rgba(100, 116, 139, 0.2)',
      '--admin-card': '#141E2E',
      '--admin-card-border': 'rgba(100, 116, 139, 0.12)',
      '--font-main': "'Inter', system-ui, sans-serif",
...
export const DEFAULT_THEME = 'luxury-gold';
...
export function ThemeProvider({ children }) {
  const [themeId, setThemeId] = useState(() => {
    return localStorage.getItem('elkhalil_theme') || DEFAULT_THEME;
  });
  ...
  const applyTheme = (id) => {
    ...
    // Remove old body theme classes, add new one
    Object.values(THEMES).forEach(t => {
      document.body.classList.remove(t.bodyClass);
    });
    document.body.classList.add(theme.bodyClass);

    // Bridge to legacy --gold vars for full backwards compatibility
